...
// ✅ Extract your existing App logic into a separate component
const UtilitiesPage = () => {
  ...
  return (
    <main className="pt-16 flex-1">
      {/* ✅ Add SEO for individual utilities */}
      {currentUtility && (
        <SEO
          title={`${currentUtility.title} - Developer Utilities Suite`}
          description={currentUtility.description}
          canonical={`/utility/${currentUtility.id}`}
        />
      )}

      {/* ✅ Add SEO for homepage when no utility selected */}
      {!currentUtility && <SEO />}

      {currentUtility ? (
        // Individual Utility View - EXACTLY YOUR EXISTING CODE
        ...
        // Grid View - EXACTLY YOUR EXISTING CODE
        <div className="max-w-7xl mx-auto p-4 sm:p-6">
          <div className="mb-8">
          ...
          {results.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Try adjusting your search query or browse all utilities below.
              </p>
            </div>
          ) : (
                    ...
                    "
                      >
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          {categoryCount} tool{categoryCount !== 1 ? "s" : ""}
                        </div>
                      </button>
                    );
                  }
...
// ✅ Main App component - just adds routing wrapper
function App() {
  return (
    <ThemeProvider>
      <Router>
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors flex flex-col">
          ...
          <Routes>
            <Route path="/" element={<UtilitiesPage />} />
            <Route
              path="/about"
              element={
                <>
                  <SEO
                    title="About - Developer Utilities Suite | 31 Essential Tools"
                    description="Learn about our comprehensive developer utilities suite with 31 tools built with modern React."
                    canonical="/about"
                  />
                  <About />
                </>
